...
Barcode::Matrix2of5 - Create pattern for Matrix 2 of 5

=head1 SYNOPSIS

    use Barcode::Matrix2of5;
    
    my $bc = new Barcode::Matrix2of5;
	 my $text = '123459';
...
Barcode::Matrix2of5 creates the patterns that you need to display
Matrix 2 of 5 barcodes.  The pattern returned is a string of 1's and 0's,
...
# standard 1 2 4 7 P pattern, encodes as bars and spaces
my %patterns = (
	'(' => 'wnnnn',
	'0' => 'nnwwn',
	'1' => 'wnnnw',
...
Create a new Barcode::Matrix2of5 object. The different options that can
be set are:
...
Example:
	 ...
	 $bc = new Barcode::Matrix2of5(addcheck => 1);

    Create a new Matrix 2/5 barcode object that will automatically add check digits.
